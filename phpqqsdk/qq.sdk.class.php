...
class Oauth2 {
    ...
    function get_authorized_url($appid, $scope, $callback) {
      //-------生成唯一随机串防CSRF攻击
    ...
    public function get_access_token($appid, $appkey, $code, $callback){
    ...
    public function showError($code, $description = '$'){
        ...
        trigger_error("$code : $description", E_USER_ERROR);
...
/*
 * @brief QClient类，api外部对象，调用接口全部依赖于此对象
 * */
class QClient {
     ...
     * @return Object QC
     */
    public function __construct($appid, $openid, $access_token){
        $this->keysArr = array(
    ...
    function showError($ret, $msg) {
      trigger_error("$ret:$msg", E_USER_ERROR);
    }
